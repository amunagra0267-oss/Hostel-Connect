    ...
    setTimeout(() => {
      ...
      if (result.success) {
        if (result.generatedPassword) {
          // inform the user of the generated random password (dev/testing)
          // in production you would not display passwords like this
          alert(
            `Logged in. Your generated password (saved to localStorage if 'Remember me' checked): ${result.generatedPassword}`
          );
        }
